...
import by.parakhnevich.branchingandloops.utilloops.ArePointsOnLine;
...
public class ArePointsOnLineCommand implements Command{
    ...
    public String execute(List<String> list) {
        ArePointsOnLine arePointsOnLine = new ArePointsOnLine(Parser.parseListToDouble(list));
        return String.format(LocaleSingleton.getResourceBundle().getString("RESULT_1"),
                arePointsOnLine.define());
    }
}
