...
public class RightShiftFillingWithZeros implements PartOfExpression {
    PartOfExpression leftPartOfExpression;
    PartOfExpression rightPartOfExpression;

    public RightShiftFillingWithZeros(PartOfExpression leftPartOfExpression, PartOfExpression rightPartOfExpression) {
