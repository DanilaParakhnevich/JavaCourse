...
public class ThreadWithCountDownLatchTest {
    ...
    @DataProvider(name = "positiveDataForCountDownLatchThread")
    ...
    @Test(description = "Test with positive scenario for usability" +
            ...
            dataProvider = "positiveDataForCountDownLatchThread")
    public void testRun(Matrix matrix1, List<Integer> list) throws InterruptedException {
        new PutNumbersInMainDiagonal().execute(new ThreadsWithCountDownLatchCreator().
                create(list, matrix1));
