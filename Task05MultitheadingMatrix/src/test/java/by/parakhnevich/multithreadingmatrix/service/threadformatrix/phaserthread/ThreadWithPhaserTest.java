...
public class ThreadWithPhaserTest {
    ...
    @DataProvider(name = "positiveDataForPhaserThread")
    public Object[][] createPositiveDataForPhaserThread() throws DAOException, IOException {
        return new Object[][]{
    ...
    @Test(description = "Test with positive scenario for usability" +
            ...
            dataProvider = "positiveDataForPhaserThread")
    public void testRun(Matrix matrix1, List<Integer> list) throws InterruptedException {
        new PutNumbersInMainDiagonal().execute(new ThreadsWithPhaserCreator().
                create(list, matrix1));
